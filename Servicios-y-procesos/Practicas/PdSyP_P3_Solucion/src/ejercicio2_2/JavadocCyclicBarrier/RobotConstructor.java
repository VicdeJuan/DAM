...
public class RobotConstructor extends Robot{
	 ...
	 */
	private static int estructurasConstruidas = 0; // Los comentarios de variables van aquí.
	 ...
	 */
	 ...
	 /**
	  * Método que simula las operaciones del Robot Constructor.
	  */
	 @Override
	 public void operar() {
